...
function Portrait({
  ...
  return (
    <figure className={`flex flex-col gap-3.5 ${className}`}>
      <div
        className={`grid aspect-[3/4] w-full place-items-center overflow-hidden rounded-[22px] border border-line shadow-[0_30px_50px_-34px_rgba(28,24,19,0.45)] ${STRIPES}`}
      >
...
export default function HeroFaces() {
  ...
  return (
    ...
    >
      <Wrap className="grid min-h-[76vh] grid-cols-[1.1fr_0.9fr] items-center gap-16 pb-[70px] max-[920px]:min-h-0 max-[920px]:grid-cols-1 max-[920px]:gap-12 max-[920px]:pt-2.5">
        <div>
        ...
        <div className="max-[920px]:mx-auto max-[920px]:max-w-[420px]">
          <div className="grid grid-cols-2 items-start gap-5 pb-10">
            <Portrait name="Jason" role="Design & Engineering" />
            <Portrait
              name="Arjun"
