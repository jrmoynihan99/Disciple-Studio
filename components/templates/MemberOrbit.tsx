...
export default function MemberOrbit({ config }: { config: ChurchConfig }) {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-[radial-gradient(1100px_700px_at_50%_-10%,_rgb(var(--brand)_/_calc(0.16_*_var(--glow))),_transparent_62%),var(--paper)] text-ink">
      {/* Ambient drifting glow */}
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="absolute left-1/2 top-[34%] h-[70vw] w-[70vw] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,_rgb(var(--brand)_/_calc(0.10_*_var(--glow))),_transparent_64%)] blur-[40px] animate-[edDrift1_34s_ease-in-out_infinite]" />
      </div>
