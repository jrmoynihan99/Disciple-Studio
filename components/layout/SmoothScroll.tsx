...
// which the click interceptor in Providers relies on).
  ...
  return (
    <ReactLenis
      ...
      options={{
        ...
        syncTouch: false,
        // Same-page hash links — CSS scroll-behavior:smooth is off (it fights
        // Lenis and the view-transition scroll restoration), so Lenis takes
        // over anchor scrolling instead.
        anchors: true,
      }}
    >
      {children}
